...
public:
    ...
    void setupUi(QMainWindow *hanoiTowers)
    {
        ...
        T1label->setAutoFillBackground(false);
        T1label->setAlignment(Qt::AlignCenter);
        ...
        T2label->setAutoFillBackground(false);
        T2label->setAlignment(Qt::AlignCenter);
        ...
        T3label->setContextMenuPolicy(Qt::DefaultContextMenu);
        T3label->setAutoFillBackground(false);
        T3label->setTextFormat(Qt::AutoText);
        T3label->setScaledContents(false);
        T3label->setAlignment(Qt::AlignCenter);
