...
#include <memory>
#include "../Aufgabe2/taschenrechner.h"
...
struct qt_meta_stringdata_Taschenrechner_t {
    QByteArrayData data[4];
    char stringdata0[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Taschenrechner_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Taschenrechner_t qt_meta_stringdata_Taschenrechner = {
    {
QT_MOC_LITERAL(0, 0, 14), // "Taschenrechner"
QT_MOC_LITERAL(1, 15, 20), // "on_Calculate_Clicked"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 21) // "on_pushButton_clicked"

    },
    "Taschenrechner\0on_Calculate_Clicked\0"
...
QT_INIT_METAOBJECT const QMetaObject Taschenrechner::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_Taschenrechner.data,
    qt_meta_data_Taschenrechner,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Taschenrechner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Taschenrechner.stringdata0))
